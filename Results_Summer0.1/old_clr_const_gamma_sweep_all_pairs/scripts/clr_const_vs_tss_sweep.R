# =============================================================================
# Sweep: CLR (with constant) vs TSS across gamma and constant combinations
# =============================================================================
...
sweepdir <- paste0(outdir, "clr_constant_sweep/")
...
for (g in gammas) {
  for (k in constants) {
    ...
    pdfname <- paste0(sweepdir, "gamma_", g, "/clr_const", k_label, "_vs_tss.pdf")
    ...
    for (i in 1:ncol(pairs)) {
      ...
      plot(x, y,
           ...
           main = paste0(comp_name, " – CLR(const=", k,
                         ") vs TSS (gamma = ", g, ")"),
